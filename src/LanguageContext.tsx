...
const translations: Record<Language, Record<TranslationKeys, string>> = {
  en: {
    ...
    contactAddress: 'Ukmergės g. 240, Vilnius, Lithuania, 06120',
  ...
  lt: {
    ...
    contactSubtitle: 'Apsilankykite mūsų užeigoje Ukmergės g. arba užsisakykite pristatymą tiesiai į namus.',
    contactAddress: 'Ukmergės g. 240, Vilnius, Lietuva, 06120',
    contactPhone: '+370 612 34567',
    contactEmail: 'hello@haduskabab.lt',
